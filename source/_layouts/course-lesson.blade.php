    ...
    <div id="sidebar" class="hidden fixed inset-0 pt-16 h-full bg-white z-90 w-full border-b -mb-16 lg:-mb-0 lg:static lg:h-auto lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5">
      ...
      <div id="navWrapper" class="h-full overflow-y-auto scrolling-touch lg:h-auto lg:block lg:relative lg:sticky lg:top-16 bg-white lg:bg-transparent">
        ...
        <nav id="nav" class="px-6 pt-6 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-(screen-16)">
          ...
          <div class="mb-10">
            <a href="/" class="flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/') ? 'text-gray-900' : 'text-gray-600' }}">
            ...
            <a href="/projects" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/projects') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="/a-great-fit" data-external class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ ($page->categoryActive('/a-great-fit') || $page->categoryActive('/screencasts')) ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="/testimonials" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/testimonials') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
