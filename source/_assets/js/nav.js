  ...
  window.history.replaceState(
    {
      ...
      navClasses: $(document)
        .find("#nav")
        .attr("class"),
      navGradientClasses: $(document)
        .find("#navGradient")
        .attr("class"),
      navWrapperClasses: $(document)
        .find("#navWrapper")
        .attr("class"),
      content: $(document)
        .find("#content")
  ...
  $("#nav").on("click", "a:not([data-external])", function(event) {
    ...
    $.get(href, html => {
      ...
      const header = $(html)
        .find("#header")
        .html();
      const sidebarClasses = $(html)
        .find("#sidebar")
        .attr("class");
      const nav = $(html)
        .find("#nav")
        .html();
      const navClasses = $(html)
        .find("#nav")
        .attr("class");
      const navGradientClasses = $(html)
        .find("#navGradient")
        .attr("class");
      const navWrapperClasses = $(html)
        .find("#navWrapper")
        .attr("class");
      const content = $(html)
        .find("#content")
      ...
      window.history.pushState(
        {
          ...
          navClasses: $(html)
            .find("#nav")
            .attr("class"),
          navGradientClasses: $(html)
            .find("#navGradient")
            .attr("class"),
          navWrapperClasses: $(html)
            .find("#navWrapper")
            .attr("class"),
          content: $(html)
            .find("#content")
