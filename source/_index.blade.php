...
<div class="flex flex-col">
  <div class="min-h-screen bg-pattern bg-center bg-gray-200 border-t-6 border-tailwind-teal flex items-center justify-center leading-tight p-6 pb-16">
    <div>
      ...
      <h2 class="mt-12 font-normal text-3xl sm:text-4xl text-center">A Human Full Stack Developer<br class="hidden sm:inline-block"> for rapidly building awesome UI tools for developers.</h2>
